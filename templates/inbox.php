...
<!-- jQuery -->
<!-- lined-icons -->
<link rel="stylesheet" href="templates/css/icon-font.min.css" type='text/css' />
<!-- //lined-icons -->
<!-- chart -->
<script src="templates/js/Chart.js"></script>
<!-- //chart -->
<!--animate-->
<link href="templates/css/animate.css" rel="stylesheet" type="text/css" media="all">
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li><a href="tables.php"><i class="lnr lnr-menu"></i> <span>Tables</span></a></li>              
						...
						<li class="menu-list"><a href="#"><i class="lnr lnr-book"></i>  <span>Pages</span></a> 
							<ul class="sub-menu-list">
								...
								<li><a href="blank_page.php">Blank Page</a></li>
							</ul>
						</li>
					</ul>
				<!--sidebar nav end-->
							...
							<div class="content-box  mrg15B">
							  <div class="content-box-wrapper text-center">
								...
								<div class="status-badge mrg10A">
									<img class="img-circle" width="40" src="templates/images/1.png" alt="">
									<div class="small-badge bg-red"></div>
								</div>
								<div class="status-badge mrg10A">
									<img class="img-circle" width="40" src="templates/images/3.png" alt="">
									<div class="small-badge bg-red"></div>
								</div>
								<div class="status-badge mrg10A">
									<img class="img-circle" width="40" src="templates/images/4.png" alt="">
									<div class="small-badge bg-green1"></div>
								</div>
								<div class="status-badge mrg10A">
									<img class="img-circle" width="40" src="templates/images/5.png" alt="">
							...
							<div class="activity_box">
								...
								<div class="scrollbar scrollbar1" id="style-2">
									<div class="activity-row">
										<div class="col-xs-3 activity-img"><img src="templates/images/1.png" class="img-responsive" alt=""></div>
									...
									<div class="activity-row">
										<div class="col-xs-3 activity-img"><img src="templates/images/5.png" class="img-responsive" alt=""></div>
										<div class="col-xs-7 activity-desc">
									...
									<div class="activity-row">
										<div class="col-xs-3 activity-img"><img src="templates/images/3.png" class="img-responsive" alt=""></div>
										<div class="col-xs-7 activity-desc">
									...
									<div class="activity-row">
										<div class="col-xs-3 activity-img"><img src="templates/images/4.png" class="img-responsive" alt=""></div>
										<div class="col-xs-7 activity-desc">
							...
							<div class="activity_box activity_box1">
								...
								<div class="scrollbar" id="style-2">
									<div class="activity-row activity-row1">
										<div class="col-xs-3 activity-img"><img src="templates/images/1.png" class="img-responsive" alt=""><span>10:00 PM</span></div>
									...
									<div class="activity-row activity-row1">
										...
										<div class="col-xs-3 activity-img"><img src="templates/images/3.png" class="img-responsive" alt=""><span>10:02 PM</span></div>
										<div class="clearfix"> </div>
									</div>
									<div class="activity-row activity-row1">
										<div class="col-xs-3 activity-img"><img src="templates/images/1.png" class="img-responsive" alt=""><span>10:00 PM</span></div>
